 ...
 * - MCP_USE_OAUTH_KEYCLOAK_SERVER_URL  (default: http://localhost:8080)
 * - MCP_USE_OAUTH_KEYCLOAK_REALM       (default: demo)
 * - MCP_USE_OAUTH_KEYCLOAK_AUDIENCE    (optional — enforces `aud` claim)
 */
...
/**
 * Returns identity info extracted from the Keycloak access token.
 */
server.tool(
  {
    name: "get-user-info",
...
/**
 * Fetches the full OIDC userinfo document from Keycloak using the bearer token.
 */
server.tool(
  {
